...
Partial Class firearmsapplication
    ...
    '    Me.txtrehabid.Text = Session("licenseid")
    ...
    '    Cmd.Parameters.AddWithValue("@dcplid", Me.txtrehabid.Text)
    ...
    Sub AddReport()
        ...
        Try
            Me.txtrehabid.Text = Session("rehabid")
            ...
            mydiscretevalue.Value = Me.txtrehabid.Text
    ...
    Sub UpdateHospitalLetterDate()
        ...
        Try
            ...
            Dim find_pistol As SqlCommand = New SqlCommand("Update_HospitalLetterDate", pistolconn)

            find_pistol.Parameters.AddWithValue("@rehabid", Session("rehabid"))
