...
Partial Class DuplicateLicenseAffidavit
    Inherits System.Web.UI.Page

    'Sub licensedataset()

    '    Me.txtduplID.Text = Session("licenseid")
    ...
    '    Cmd.Parameters.AddWithValue("@dcplid", Me.txtduplID.Text)
    ...
    Sub AddReport()
        ...
        Try
            Me.txtduplID.Text = Session("duplid")
            ...
            mydiscretevalue.Value = Me.txtduplID.Text
