...
Partial Class MailedLabelPrint
    ...
    Sub AddReport()
        Try
            ...
            'Call UpdateMailingDate() I COMMMENT THIS FUNCTIO OUT. I THINK FIELD SHOULD BE UPDATED ONLY WHEN REPORT RUNNING, NOT LAabel Printing
