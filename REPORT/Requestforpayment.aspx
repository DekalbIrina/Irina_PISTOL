<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Requestforpayment.aspx.vb" Inherits="LicenseWaiver" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="Requestforpayment.rpt">
                <Parameters>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp;<br />
        <asp:Label ID="lblError" runat="server" BackColor="Red" Font-Bold="True" ForeColor="White"
            Visible="False" Width="416px"></asp:Label><br />
