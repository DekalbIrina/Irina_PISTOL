...
Imports System.Data
Partial Class FirstTimeLicensePrint
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        ...
        Try
            'I COMMENT IT OUT, Becouse I am not sure I have to check it here, or
            'in Appliacation package. So far, I just will call this License. 
            'UNCOMMENT this codd.  I think Pistol License should not be part of package. It should be printed separatly from menu. 
            ...
            Else
                ...
                Me.lblFailed.Visible = True
                Me.lblFailed.Text = "You are not able to print FistTime License for  " & " " & LicenseType & " " & "License Type."
            End If
