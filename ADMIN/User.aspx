<%@ Page Language="VB" AutoEventWireup="false" CodeFile="User.aspx.vb" Inherits="AddUser" %>
...
<body>
    ...
    <div style="background-color: background">
        <span><span><span style="color: background"><span style="text-decoration: underline"><span style="font-size: 16pt"></span>
        </span>
        </span>
        </span></span><strong><span style="font-size: 16pt; color: darkblue; text-decoration: underline">
            <span style="background-color: background">
                ...
                &nbsp; &nbsp; &nbsp;<asp:Label ID="lblTitle" runat="server" Font-Bold="True" ForeColor="White"
                    Text="Add User" Width="144px"></asp:Label><br />
                <br />
        ...
        <asp:Label ID="lblSuccess" runat="server" BackColor="Lavender" BorderStyle="Ridge"
            Font-Bold="True" ForeColor="Navy" Height="24px" Width="608px"></asp:Label><br />
            &nbsp;<asp:Label ID="lblerror" runat="server" Font-Bold="True" ForeColor="White" Width="568px" BackColor="Red" BorderStyle="Ridge" Height="40px"></asp:Label></span></strong><br />
        ...
        <asp:TextBox ID="txtusername" runat="server" ToolTip="Enter UserName" Width="208px"></asp:TextBox>
        &nbsp;&nbsp;<br />
        ...
        <asp:RequiredFieldValidator ID="ValidateDate" runat="server" ControlToValidate="txtdateadded"
            ErrorMessage="Please Enter Date" Font-Bold="True"></asp:RequiredFieldValidator><br />
        &nbsp;
        <br />
        ...
        <asp:Label ID="lblOperator" runat="server" BackColor="SteelBlue" Font-Bold="True"
            ForeColor="White" Text="Added By:" ToolTip="Operator Name" Width="152px"></asp:Label>&nbsp;
        <asp:TextBox ID="txtOperator" runat="server" BackColor="#FFFFC0" Font-Bold="True"
            ForeColor="Black" ReadOnly="True"></asp:TextBox><br />
        &nbsp;
        &nbsp; &nbsp;&nbsp;<br />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="btnaddUser" runat="server" Text="Add User" ToolTip="Add User" BackColor="White" Font-Bold="True" ForeColor="Navy" />
