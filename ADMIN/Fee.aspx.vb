...
Partial Class Proofofdeceased
    ...
    Protected Sub Btnaddcategory_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnaddcategory.Click
        ...
        Try
            ...
            Dim cmdpistol As SqlCommand = New SqlCommand("insert_fee", pistolconn)


            cmdpistol.Parameters.AddWithValue("@feeamount", CDbl(Me.txtcategory.Text))
            ...
            Response.Write("Fee Amount has been added to Database: " & "$" & a)
