...
Partial Class Proofofdeceased
    ...
    Protected Sub Btnaddcategory_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnaddcategory.Click
        ...
        Try
            ...
            Dim cmdpistol As SqlCommand = New SqlCommand("insert_agency", pistolconn)


            cmdpistol.Parameters.AddWithValue("@AgencyName", Me.txtcategory.Text)
        ...
        Catch ex As Exception
            ...
            ex.Message.ToString()
            Response.Write("You are not able to add Agency. Please contact IS. " & a)
        End Try
        pistolconn.Close()
    End Sub
