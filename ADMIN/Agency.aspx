<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Agency.aspx.vb" Inherits="Proofofdeceased" %>
...
<body>
    ...
    <div>
        <span><span><span><span style="text-decoration: underline"><span style="background-color: #003399">
            <span style="color: white; font-size: 14pt;"><strong>AGENCY / DEPARTMENT<br />
            </strong>
            </span></span>
        </span>
        </span>
        ...
        <table style="border-left-color: #000099; border-bottom-color: #000099; border-top-style: solid; border-top-color: #000099; border-right-style: solid; border-left-style: solid; height: 354px; background-color: background; border-right-color: #000099; border-bottom-style: solid; text-align: center;">
            <tr>
                ...
                <td style="width: 346px; height: 318px; background-color: lightgrey">
                    <asp:Label ID="lblagency" runat="server" BackColor="SteelBlue" Font-Bold="True"
                        ForeColor="White" Text="Agency" ToolTip="Agency" Width="65px"></asp:Label>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cnpistol %>"
            SelectCommand="SELECT [ID], [Agency] FROM [Agency] ORDER BY [Agency]" ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [Agency] WHERE [ID] = @original_ID AND [Agency] = @original_Agency" InsertCommand="INSERT INTO [Agency] ([Agency]) VALUES (@Agency)" OldValuesParameterFormatString="original_{0}" UpdateCommand="UPDATE [Agency] SET [Agency] = @Agency WHERE [ID] = @original_ID AND [Agency] = @original_Agency" ProviderName="<%$ ConnectionStrings:cnpistol.ProviderName %>">
            <DeleteParameters>
                <asp:Parameter Name="original_ID" Type="Int32" />
                <asp:Parameter Name="original_Agency" Type="String" />
            </DeleteParameters>
            <UpdateParameters>
