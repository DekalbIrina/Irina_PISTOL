<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CopyLicenseList.aspx.vb" Inherits="CopyLicenseList" %>
        ...
        <span style="font-size: 16pt;
            color: #000099"><strong><em><span style="color: infotext"><span style="text-decoration: underline overline">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button
                    ...
                    Text="Pistol License" ToolTip="Return to Pistol License Detail Screen" Width="122px" /><br />
            </strong></span>&nbsp;
        &nbsp;
        &nbsp;&nbsp;<br />
        <br />
        <asp:GridView ID="grddisplaced" runat="server" BackColor="White" BorderColor="#999999"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="TransID"
                    DataTextField="TransID" HeaderImageUrl="~/Images/PREVIEW.BMP" DataNavigateUrlFormatString="~/LICENSE/CopyLicenseDetails.aspx?id={0}" />
            </Columns>
