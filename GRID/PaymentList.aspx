<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PaymentList.aspx.vb" Inherits="ArrestList" %>
...
<body style="color: #000000">
    ...
    <div>
        ...
        &nbsp;&nbsp;<br />
        <br />
        <asp:GridView ID="grdpayments" runat="server" BackColor="White" BorderColor="#999999"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="TransactionID" DataNavigateUrlFormatString="paymentdetails.aspx?id={0}"
                    DataTextField="TransactionID" HeaderImageUrl="~/Images/PREVIEW.BMP" />
            </Columns>
