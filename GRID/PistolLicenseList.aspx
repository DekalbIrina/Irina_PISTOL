<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PistolLicenseList.aspx.vb" Inherits="ArrestList" %>
    ...
    <div>
        <span><span style="background-color: #006699"></span>
            ...
            color: #000099"><strong><em><span style="color: infotext"><span style="text-decoration: underline overline">
                Pistol License History</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
            </em>&nbsp; &nbsp;&nbsp;
                <br />
                <br />
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <br />
        <asp:GridView ID="grdlicense" runat="server" CellPadding="3" Font-Size="Small"
            ...
            <Columns>
                <asp:ButtonField CommandName="Select" DataTextField="DCPLID" HeaderImageUrl="~/Images/PREVIEW.BMP" />
            </Columns>
        </asp:GridView>
        &nbsp;<br />
        <br />
