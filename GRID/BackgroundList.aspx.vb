...
Partial Class BackgroundList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim mystring = Session("licenseid")
        ...
        Try
            Dim cmdpistol As SqlCommand = New SqlCommand("sel_checklist", pistolconn)

            cmdpistol.Parameters.AddWithValue("@dcplid", mystring)
            ...
            Me.grdbackground.DataSource = pistol_data
            Me.DataBind()
