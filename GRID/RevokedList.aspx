<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RevokedList.aspx.vb" Inherits="ArrestList" %>
        ...
        <asp:GridView ID="grddisplaced" runat="server" BackColor="White" BorderColor="#999999"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="ID"
                    DataTextField="ID" HeaderImageUrl="~/Images/PREVIEW.BMP" DataNavigateUrlFormatString="~/License/revokeddetails.aspx?id={0}" />
            </Columns>
